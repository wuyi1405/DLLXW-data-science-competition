    ...
    def build_encoder(arch='resnet50dilated', fc_dim=512, weights=''):
        ...
        if len(weights) > 0:
            ...
            net_encoder.load_state_dict(
                torch.load(weights, map_location=lambda storage, loc: storage)["encoder"], strict=False)
        return net_encoder
    ...
    def build_decoder(arch='ppm_deepsup',
        ...
        if len(weights) > 0:
            ...
            net_decoder.load_state_dict(
                torch.load(weights, map_location=lambda storage, loc: storage)["decoder"], strict=False)
        return net_decoder
